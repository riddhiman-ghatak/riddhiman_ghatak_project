...
# Load the CSV file
df = pd.read_csv('anomaly_results_lstm.csv')  # Replace 'your_file.csv' with your actual file path

# Convert 'Time' column to datetime
df['Time'] = pd.to_datetime(df['Time'])

# Create the plot
fig = px.line(df, x='Time', y='Value', title='Time vs Value with Anomalies Marked using lstm autoencoder')
